      ...
      <View style={styles.content}>
        <View style={styles.salary}>
          ...
          >
            <Text numberOfLines={1} style={styles.item}>
              ...
              (post.salary_min === undefined && post.salary_max === undefined)
                ? "Thỏa thuận"
                : post.salary_min >= 0 && post.salary_max >= 10000
                ? post.salary_min / 1000000 +
                  "tr" +
                  " - " +
                  post.salary_max / 1000000 +
                  "tr"
        ...
        <View style={styles.address}>
          ...
          <Text style={styles.item}>
            {post.province_name ? post.province_name : "Không xác định"}
          </Text>
        </View>
