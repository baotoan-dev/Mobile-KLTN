    ...
    <!DOCTYPE html>
        ...
        <div style="overflow: hidden;width: 45%; height: 100%; flex-direction: column; background-color: #c1e8e4;">
            <div>
                    ...
                    <div style="padding: 30px;">
                        ...
                        <div style="display: flex; flex-direction: row; gap: 20px; align-items: center;">
                            ...
                            <div style="font-size: 30px; word-wrap: break-word;">baotoandd2016@gmail.com</div>
                        </div>
                        <div style="display: flex; flex-direction: row; gap: 20px; align-items: center;">
                             <i class="fas fa-phone" style="font-size: 30px"></i>
                            <div style="font-size: 30px;word-wrap: break-word;">0765969802</div>
                        </div>
                        <div style="display: flex; flex-direction: row; gap: 20px; align-items: center;">
                            <i class="fas fa-address-book" style="font-size: 30px"></i>
                            <div style="font-size: 30px;word-wrap: break-word;">Dĩ An District, Bình Dương Province, Vietnam </div>
                        </div>
                        </div>
                    </div>
                </div>
            ...
            <div style="width: 55%; height: 100%">
                <div style="margin: 30px; font-size: 30px; font-weight: 700;">
                    HUYNH NGOC HIEU
                </div>
                <div>
