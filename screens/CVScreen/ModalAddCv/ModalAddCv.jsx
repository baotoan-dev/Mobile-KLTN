...
export default function ModalAddCv({ showModalAddCv, setShowModalAddCv }) {
    ...
    if (Platform.OS === "android") {
      try {
        ...
        if (granted !== PermissionsAndroid.RESULTS.GRANTED) {
          Alert.alert(
            "Permission Denied",
            "You need to grant storage permission to upload CVs."
          );
          return false;
        }
        return true;
          ...
          >
            ...
            >
              ...
              >
                ...
                />
                <Text style={styles.title}>Thêm CV mới</Text>
              </View>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => {
            ...
            >
              ...
              >
                ...
                />
                <Text style={styles.title}>Chọn CV từ máy</Text>
              </View>
            </TouchableOpacity>
          </View>
        </View>
