...
import {
  createFollowCompanyAction,
  getFollowCompanyAction,
} from "../../../redux/store/FollowCompany/followCompanySlice";
...
export default function ContentFollowing() {
  ...
  const handleDeleteFollowCompany = (companyId) => {
    ...
    const filteredData = listCompanyFollowing.filter(
      (item) => +item.companyInfo.id !== +companyId
    );
